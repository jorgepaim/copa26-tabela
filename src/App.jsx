...
var MATCHES=[
  ...
  {id:"m31", grp:"C",date:"19/06",time:"21h30", home:"BRA",away:"HAI",venue:"Lincoln, Philadelphia"},
  {id:"m32", grp:"D",date:"20/06",time:"00h",   home:"PAR",away:"TUR",venue:"Levis, San Francisco"},
  {id:"m33", grp:"E",date:"20/06",time:"17h",   home:"GER",away:"CIV",venue:"BMO, Toronto"},
  {id:"m34", grp:"F",date:"20/06",time:"14h",   home:"NED",away:"SWE",venue:"NRG, Houston"},
  {id:"m35", grp:"F",date:"21/06",time:"01h",   home:"JPN",away:"TUN",venue:"BBVA, Monterrey"},
  {id:"m36", grp:"E",date:"20/06",time:"21h",   home:"ECU",away:"CUW",venue:"Arrowhead, Kansas City"},
  {id:"m37", grp:"G",date:"21/06",time:"16h",   home:"BEL",away:"IRN",venue:"SoFi, Los Angeles"},
  {id:"m38", grp:"H",date:"21/06",time:"13h",   home:"ESP",away:"KSA",venue:"Mercedes-Benz, Atlanta"},
  {id:"m39", grp:"G",date:"21/06",time:"22h",   home:"EGY",away:"NZL",venue:"BC Place, Vancouver"},
  {id:"m40", grp:"H",date:"21/06",time:"19h",   home:"CPV",away:"URU",venue:"Hard Rock, Miami"},
  {id:"m41", grp:"I",date:"22/06",time:"18h",   home:"FRA",away:"IRQ",venue:"Lincoln, Philadelphia"},
  {id:"m42", grp:"I",date:"22/06",time:"21h",   home:"SEN",away:"NOR",venue:"MetLife, Nova Jersey"},
  {id:"m43", grp:"J",date:"22/06",time:"14h",   home:"ARG",away:"AUT",venue:"ATT, Dallas"},
  {id:"m44", grp:"J",date:"23/06",time:"00h",   home:"ALG",away:"JOR",venue:"Levis, San Francisco"},
  {id:"m45", grp:"K",date:"23/06",time:"14h",   home:"POR",away:"UZB",venue:"NRG, Houston"},
  {id:"m46", grp:"L",date:"23/06",time:"17h",   home:"ENG",away:"GHA",venue:"Gillette, Boston"},
  {id:"m47", grp:"K",date:"23/06",time:"23h",   home:"COD",away:"COL",venue:"Akron, Guadalajara"},
  {id:"m48", grp:"L",date:"23/06",time:"20h",   home:"CRO",away:"PAN",venue:"BMO, Toronto"},
  {id:"m49", grp:"A",date:"24/06",time:"22h",   home:"RSA",away:"KOR",venue:"BBVA, Monterrey"},
  {id:"m50", grp:"A",date:"24/06",time:"22h",   home:"MEX",away:"CZE",venue:"Azteca, Mexico"},
  {id:"m51", grp:"B",date:"24/06",time:"16h",   home:"BIH",away:"QAT",venue:"Lumen, Seattle"},
  {id:"m52", grp:"B",date:"24/06",time:"16h",   home:"SUI",away:"CAN",venue:"BC Place, Vancouver"},
  {id:"m53", grp:"C",date:"24/06",time:"19h",   home:"MAR",away:"HAI",venue:"Mercedes-Benz, Atlanta"},
  {id:"m54", grp:"C",date:"24/06",time:"19h",   home:"SCO",away:"BRA",venue:"Hard Rock, Miami"},
  {id:"m55", grp:"D",date:"25/06",time:"23h",   home:"PAR",away:"AUS",venue:"Levis, San Francisco"},
  {id:"m56", grp:"D",date:"25/06",time:"23h",   home:"TUR",away:"USA",venue:"SoFi, Los Angeles"},
  {id:"m57", grp:"E",date:"25/06",time:"17h",   home:"CUW",away:"CIV",venue:"Lincoln, Philadelphia"},
  {id:"m58", grp:"E",date:"25/06",time:"17h",   home:"ECU",away:"GER",venue:"MetLife, Nova Jersey"},
  {id:"m59", grp:"F",date:"25/06",time:"20h",   home:"TUN",away:"NED",venue:"Arrowhead, Kansas City"},
  {id:"m60", grp:"F",date:"25/06",time:"20h",   home:"SWE",away:"JPN",venue:"ATT, Dallas"},
  {id:"m61", grp:"G",date:"27/06",time:"00h",   home:"NZL",away:"BEL",venue:"BC Place, Vancouver"},
  {id:"m62", grp:"H",date:"26/06",time:"21h",   home:"URU",away:"ESP",venue:"Akron, Guadalajara"},
  {id:"m63", grp:"G",date:"27/06",time:"00h",   home:"EGY",away:"IRN",venue:"Lumen, Seattle"},
  {id:"m64", grp:"H",date:"26/06",time:"21h",   home:"KSA",away:"CPV",venue:"NRG, Houston"},
  {id:"m65", grp:"I",date:"26/06",time:"16h",   home:"NOR",away:"FRA",venue:"Gillette, Boston"},
  {id:"m66", grp:"I",date:"26/06",time:"16h",   home:"IRQ",away:"SEN",venue:"BMO, Toronto"},
  {id:"m67", grp:"J",date:"27/06",time:"23h",   home:"JOR",away:"ARG",venue:"ATT, Dallas"},
  {id:"m68", grp:"J",date:"27/06",time:"23h",   home:"ALG",away:"AUT",venue:"Arrowhead, Kansas City"},
  {id:"m69", grp:"K",date:"27/06",time:"20h30", home:"COL",away:"POR",venue:"Hard Rock, Miami"},
  {id:"m70", grp:"K",date:"27/06",time:"20h30", home:"UZB",away:"COD",venue:"Mercedes-Benz, Atlanta"},
  {id:"m71", grp:"L",date:"27/06",time:"18h",   home:"PAN",away:"ENG",venue:"MetLife, Nova Jersey"},
  {id:"m72", grp:"L",date:"27/06",time:"18h",   home:"CRO",away:"GHA",venue:"Lincoln, Philadelphia"},
];
...
var PHASES=[
  {key:"grupos",   label:"Grupos",   start:"11/06",end:"27/06"},
  {key:"qualified",label:"Classif."},
  {key:"r32",      label:"R/32",     start:"28/06",end:"03/07"},
  {key:"r16",      label:"Oitavas",  start:"04/07",end:"07/07"},
  {key:"qf",       label:"Quartas",  start:"09/07",end:"11/07"},
...
// Datas, horários (BRT) e locais — confronto oficial FIFA Copa 2026 (R/32 a final)
// R32_FORMULA/R32_INFO seguem a ordem J74,J77,J73,J75,J83,J84,J81,J82,J76,J78,J79,J80,J86,J88,J85,J87
// (essa ordem faz com que o pareamento sequencial de next() reproduza exatamente a chave oficial)
var R32_FORMULA=[
  {home:"1E",away:"3E"}, // J74
  {home:"1I",away:"3I"}, // J77
  {home:"2A",away:"2B"}, // J73
...
var R32_INFO=[
  {date:"29/06",time:"17h30",venue:"Gillette, Boston"},
  {date:"30/06",time:"18h",venue:"MetLife, Nova Jersey"},
  {date:"28/06",time:"16h",venue:"SoFi, Los Angeles"},
  {date:"29/06",time:"22h",venue:"BBVA, Monterrey"},
  {date:"02/07",time:"20h",venue:"BMO, Toronto"},
  {date:"02/07",time:"16h",venue:"SoFi, Los Angeles"},
  {date:"01/07",time:"21h",venue:"Levis, San Francisco"},
  {date:"01/07",time:"17h",venue:"Lumen, Seattle"},
  {date:"29/06",time:"14h",venue:"NRG, Houston"},
  {date:"30/06",time:"14h",venue:"ATT, Dallas"},
  {date:"30/06",time:"22h",venue:"Azteca, Mexico"},
  {date:"01/07",time:"13h",venue:"Mercedes-Benz, Atlanta"},
  {date:"03/07",time:"19h",venue:"Hard Rock, Miami"},
  {date:"03/07",time:"15h",venue:"ATT, Dallas"},
  {date:"03/07",time:"00h",venue:"BC Place, Vancouver"},
  {date:"03/07",time:"22h30",venue:"Arrowhead, Kansas City"}
];
var R16_INFO=[
  {date:"04/07",time:"18h",venue:"Lincoln, Philadelphia"},
  {date:"04/07",time:"14h",venue:"NRG, Houston"},
  {date:"06/07",time:"16h",venue:"ATT, Dallas"},
  {date:"06/07",time:"21h",venue:"Lumen, Seattle"},
  {date:"05/07",time:"17h",venue:"MetLife, Nova Jersey"},
  {date:"05/07",time:"21h",venue:"Azteca, Mexico"},
  {date:"07/07",time:"13h",venue:"Mercedes-Benz, Atlanta"},
  {date:"07/07",time:"17h",venue:"BC Place, Vancouver"}
];
var QF_INFO=[
  {date:"09/07",time:"17h",venue:"Gillette, Boston"},
  {date:"10/07",time:"16h",venue:"SoFi, Los Angeles"},
  {date:"11/07",time:"18h",venue:"Hard Rock, Miami"},
  {date:"11/07",time:"22h",venue:"Arrowhead, Kansas City"}
];
var SF_INFO=[
  {date:"14/07",time:"16h",venue:"ATT, Dallas"},
  {date:"15/07",time:"16h",venue:"Mercedes-Benz, Atlanta"}
];
var THIRD_INFO={date:"18/07",time:"18h",venue:"Hard Rock, Miami"};
var FINAL_INFO={date:"19/07",time:"16h",venue:"MetLife, Nova Jersey"};

// Tabela oficial FIFA (Anexo C): para cada combinação dos 4 grupos cujo 3º
// colocado NÃO se classifica (495 = C(12,4)), define a qual grupo vencedor
// (slots A,B,D,E,G,I,K,L) cada 3º colocado classificado é associado no R/32.
// Cada bloco de 12 caracteres = 4 letras dos grupos "de fora" (ordem alfabética)
// + 8 letras dos grupos sorteados para os slots, na ordem de THIRD_PLACE_SLOTS.
var THIRD_PLACE_SLOTS=["A","B","D","E","G","I","K","L"];
var THIRD_PLACE_RAW="";
var THIRD_PLACE_TABLE=[];
for(var tpi=0;tpi<THIRD_PLACE_RAW.length;tpi+=12){ THIRD_PLACE_TABLE.push(THIRD_PLACE_RAW.slice(tpi,tpi+12)); }
function resolveThirdPlaceOpponents(bestThirdGroups){
  var missing=GROUP_KEYS.filter(function(g){return bestThirdGroups.indexOf(g)<0;}).sort().join("");
  for(var i=0;i<THIRD_PLACE_TABLE.length;i++){
    var row=THIRD_PLACE_TABLE[i];
    if(row.slice(0,4)===missing){
      var out={};
      THIRD_PLACE_SLOTS.forEach(function(slot,idx){ out[slot]=row[4+idx]; });
      return out;
    }
  }
  return null;
...
function buildKnockout(sc){
  ...
  var bestThirdGroups=q.bestThirds.map(function(t){return t.grp;});
  var thirdAssign=resolveThirdPlaceOpponents(bestThirdGroups);
  function rowFor(pos){
    var type=pos[0],grp=pos[1];
    if(type==="1") return q.winners.find(function(w){return w.grp===grp;}).row;
    if(type==="2") return q.runnersup.find(function(r){return r.grp===grp;}).row;
    var actualGrp=thirdAssign[grp];
    return q.rankedThirds.find(function(t){return t.grp===actualGrp;}).row;
  }
  function lbl(pos){
    var type=pos[0],grp=pos[1];
    if(type==="1") return "1º Grupo "+grp;
    if(type==="2") return "2º Grupo "+grp;
    return "3º Grupo "+thirdAssign[grp];
  }
  var r32=R32_FORMULA.map(function(f,i){
    var hr=rowFor(f.home),ar=rowFor(f.away); var info=R32_INFO[i];
    return {id:"ko32_"+(i+1),home:hr.id,away:ar.id,homeSeed:lbl(f.home),awaySeed:lbl(f.away),homeProjected:false,awayProjected:false,date:info.date,time:info.time,venue:info.venue};
  });
